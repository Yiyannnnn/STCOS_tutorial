...
directly. To design coordinates locally from R, run
<code>shiny::runApp(stcos_shiny_app())</code>. The interfaces accept a
histology image or an uploaded coordinate file; the hosted version also
provides image segmentation and full simulation controls.
</div>
